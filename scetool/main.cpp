// scetool.cpp : Defines the entry point for the console application.
//
...
/*! Parameters. */
s8 *_template = nullptr;
s8 *_file_type = nullptr;
s8 *_compress_data = nullptr;
s8 *_skip_sections = nullptr;
s8 *_key_rev = nullptr;
s8 *_meta_info = nullptr;
s8 *_keyset = nullptr;
s8 *_auth_id = nullptr;
s8 *_vendor_id = nullptr;
s8 *_self_type = nullptr;
s8 *_app_version = nullptr;
s8 *_fw_version = nullptr;
s8 *_add_shdrs = nullptr;
s8 *_ctrl_flags = nullptr;
s8 *_cap_flags = nullptr;
s8 *_indiv_seed = nullptr;
s8 *_license_type = nullptr;
s8 *_app_type = nullptr;
s8 *_content_id = nullptr;
s8 *_klicensee = nullptr;
s8 *_real_fname = nullptr;
s8 *_add_sig = nullptr;

/*! Input file. */
static s8 *_file_in = nullptr;
/*! Ouput file. */
static s8 *_file_out = nullptr;
...
{
	{"help", ARG_NONE, nullptr, 'h'},
	{"print-keys", ARG_NONE, nullptr, 'k'},
	{"print-infos", ARG_REQ, nullptr, 'i'},
	{"decrypt", ARG_REQ, nullptr, 'd'},
	{"encrypt", ARG_REQ, nullptr, 'e'},
	{"verbose", ARG_NONE, nullptr, 'v'},
	{"raw", ARG_NONE, nullptr, 'r'},
	{"template", ARG_REQ, nullptr, VAL_TEMPLATE},
	{"sce-type", ARG_REQ, nullptr, VAL_FILE_TYPE},
	{"compress-data", ARG_REQ, nullptr, VAL_COMPRESS_DATA},
	{"skip-sections", ARG_REQ, nullptr, VAL_SKIP_SECTIONS},
	{"key-revision", ARG_REQ, nullptr, VAL_KEY_REV},
	{"meta-info", ARG_REQ, nullptr, VAL_META_INFO},
	{"keyset", ARG_REQ, nullptr, VAL_KEYSET},
	{"self-auth-id", ARG_REQ, nullptr, VAL_AUTH_ID},
	{"self-vendor-id", ARG_REQ, nullptr, VAL_VENDOR_ID},
	{"self-type", ARG_REQ, nullptr, VAL_SELF_TYPE},
	{"self-app-version", ARG_REQ, nullptr, VAL_APP_VERSION},
	{"self-fw-version", ARG_REQ, nullptr, VAL_FW_VERSION},
	{"self-add-shdrs", ARG_REQ, nullptr, VAL_ADD_SHDRS},
	{"self-ctrl-flags", ARG_REQ, nullptr, VAL_CTRL_FLAGS},
	{"self-cap-flags", ARG_REQ, nullptr, VAL_CAP_FLAGS},
	{"self-indiv-seed", ARG_REQ, nullptr, VAL_INDIV_SEED},
	{"np-license-type", ARG_REQ, nullptr, VAL_LICENSE_TYPE},
	{"np-app-type", ARG_REQ, nullptr, VAL_APP_TYPE},
	{"np-content-id", ARG_REQ, nullptr, VAL_CONTENT_ID},
	{"np-klicensee", ARG_REQ, nullptr, VAL_KLICENSEE},
	{"np-real-fname", ARG_REQ, nullptr, VAL_REAL_FNAME},
	{"np-add-sig", ARG_REQ, nullptr, VAL_ADD_SIG},
	{nullptr, ARG_NULL, nullptr, 0}
};

static void print_version()
{
	printf("\nscetool " SCETOOL_VERSION " (C) 2011-2013 by naehrwert\n");
	printf("\nNP local license handling (C) 2012 by flatz\n");
	printf("\nminor update 0.0.2 <Public Build> 2017 by herr-master\n");
	printf("\n[Build Date/Time: %s/%s]\n", __DATE__, __TIME__);
}
...
static void parse_args(int argc, char **argv)
{
	...
	while ((c = getopt_long(argc, argv, "hki:w:d:e:vrt:0:1:s:2:m:K:3:4:5:A:6:7:8:a:9:b:c:f:l:g:j:z:", options, nullptr)) != -1)
	{
		switch(c)
		{
		case 'h':
...
int main(int argc, char **argv)
{
	...
	if((ps3 = getenv(CONFIG_ENV_PS3)) != nullptr)
		if(_access(ps3, 0) != 0)
			ps3 = nullptr;
